  ...
  return (
    <Container hover={hover} onMouseOver={handleOn} onMouseOut={handleOut} img={img} >
        ...
        {hover && 
               (<Disappear>
            <div className="links">
            <a href={live} target="_blank" rel="noreferrer"><IoIosGlobe style={{color : "#fff", width:"30px", height:"30px", marginRight:"10px"}}/></a>
            <a href={code} target="_blank" rel="noreferrer"><AiFillGithub style={{color : "#fff", width:"30px", height:"30px", marginRight:"10px"}}/></a>
        </div>
            <Details>
            <h2>{title}</h2>
